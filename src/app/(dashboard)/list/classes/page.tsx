...
return <tr key={item.id} className=' border-b border-gray-200 dark:border-gray-700 even:bg-slate-50 dark:even:bg-gray-800 text-sm hover:bg-lamaPurpleLight dark:hover:bg-gray-700 transition-colors cursor-pointer'>
  ...
  <td className='hidden md:table-cell text-gray-600 dark:text-gray-300'>{item.capacity }</td>
  <td className='text-gray-600 dark:text-gray-300'>{item.gradeId}</td>
  <td className='hidden md:table-cell text-gray-600 dark:text-gray-300'>{item.supervisor.name + " " + item.supervisor.surname}</td>
  <td>
