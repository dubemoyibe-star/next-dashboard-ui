    ...
    <div className='flex-1 p-4 flex flex-col xl:flex-row gap-4'>
      ...
      <div className='flex flex-col lg:flex-row gap-4'>
        ...
        <div className='bg-lamaSky py-6 px-4 rounded-md flex-1 flex flex-col md:flex-row lg:flex-col xl:flex-row gap-4'>
          ...
          <Image src="https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" width={144} height={144} className='w-36 h-36 xl:w-28 xl:h-28 2xl:w-36 2xl:h-36 rounded-full object-cover'/>
        </div>
           ...
           data={
            {
              ...
              firstName: "Dean",
              lastName: "Guerrero",
              phone: "+234 70 2513 7565",
              address: "123 avenue park ",
              bloodType: "A+",
              birthday: "2000-01-01",
              sex: "male",
